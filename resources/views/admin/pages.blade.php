                 ...
                 <div class="p-6 bg-white border-b border-gray-200">
                     <div class="flex flex-wrap -mx-1 overflow-hidden sm:-mx-px lg:-mx-3">
                         <div class="my-1 px-1 w-1/3 overflow-hidden sm:my-px sm:px-px lg:my-3 lg:px-3 lg:w-1/2">
                            ...
                            <h2>Products</h2>
                            <button onclick="location.href='{{ url('admin/pages/users') }}'" class="btn btn-primary">Show Users</button>
                            <button onclick="location.href='{{ url('admin/pages/products') }}'" class="btn btn-primary">Show Products</button>
                            <button onclick="location.href='{{ url('admin/pages/orders') }}'" class="btn btn-primary">Show Orders</button>
                             {{-- <table id="table_id"
